      ...
      include "coupl.inc"
      include 'PhysPars.h'
      character*512 MadLoop5_param_name
      real * 8 powheginput
...
c somewhere else
      MadLoop5_param_name='../MadLoop5_resources/param_card.dat'
      call setpara2(MadLoop5_param_name)
      call mg4_setpara("param_card.dat",.true.)
      call madtophys
      end
