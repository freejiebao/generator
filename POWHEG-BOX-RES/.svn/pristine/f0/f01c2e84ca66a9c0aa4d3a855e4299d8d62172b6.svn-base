...
c$$$      enddo
     ...
     &           '     elseif (str.eq."'//str(i)(1:lstr(i))//'") then'
         ...
         write (12,*) '        goto 20'
      enddo
      if(total_proc > 0) write (12,*) '     endif'
      write (12,*) '     '
      if (need_switching) then
     ...
     &        ' in sreal_proc.f"'
      ...
      write (12,*) '     call real_color_ifl(legs,color,ifl)'
      write (12,*) '     end'
      write (12,*) '                                 '

      write (12,*) '     subroutine real_color_ifl(legs,color,ifl)'
      write (12,*) '     implicit none'
      write (12,*) '     include "nexternal.inc"'
     ...
     2        //s//'(0:maxamps)'
         write (12,*)
     1        '     common/to_Ramps_'//s//'/amp2'//s//',jamp2'//s
      enddo
     ...
     &     access='append')
      ...
      write (15,*) ''
      write (15,*) '     flst_reallength = ',npart(1)
