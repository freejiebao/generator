...
cccc MAURO BUG? rad_tot is NEVER COMPUTED IN BOX-RES
cccc is it used by pythia or can it be replaced by a dummy value?
cccc the following routine should compute rad_tot and rad_tote 
cccc AS in BOX-V2
