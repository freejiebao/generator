...
svnversiondir=$(cd $(dirname $0) ; pwd)
...
#    Uncomment the following if you want the differences in local files to be logged
#    echo "************* Differences ***********"  >> $currdir/svnversion.txt
#    svn --config-dir=./ diff  >> $currdir/svnversion.txt
fi
