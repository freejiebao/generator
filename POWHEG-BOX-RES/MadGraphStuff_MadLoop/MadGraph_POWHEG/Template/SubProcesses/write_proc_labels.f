...
c$$$      enddo
     ...
     &     ' ",i,wgt2'
      ...
      write (12,*) '     implicit none'
      write (12,*) '     integer legs(*),color(2,*)'
      write (12,*) '     integer ifl'
      write (12,*) '     call born_color_ifl(legs,color,ifl)'
      write (12,*) '     end'
      write (12,*) '                                 '

      write (12,*) '     subroutine born_color_ifl(legs,color,ifl)'
      write (12,*) '     implicit none'
      write (12,*) '     include "nexternal.inc"'
     ...
     &           (proc_number(i)/100)*100,10)+48)
         ...
         write (12,*)
     1        '     Double Precision amp2'//s//'(maxamps), jamp2'
     2        //s//'(0:maxamps)'
         write (12,*)
     1        '     common/to_amps_'//s//'/amp2'//s//',jamp2'//s
      enddo
     ...
     &     //'color1(2,nexternal-1)'
      ...
      if (need_switching) write (12,*) '     integer ic(nexternal-1),'
     &     //'legs1(nexternal-1)'
      write (12,*) '     integer iflow,ifl,allowed_color'
      if (need_switching) write (12,*) '     logical mtc,even'
      write (12,*) '     '
      if (need_switching) then
         write (12,*) '     do i=1,nexternal-1'
     ...
     $     '(maxreshists=1)'
      ...
      write (15,*) '     integer nmaxres_real,nmaxres_born,dim_integ'
      write (15,*) '     integer i'
      write (15,*) ''
      ...
      write (15,1) 'c     endif'
      write (15,'(a,a,"=",i2)') ('c'//coup_name(j),goal_coup(j),j=1,ncoups)
      write (15,1) 'c      res_powew=4'
      write (15,1) 'c      res_powst=2'
      write (15,1) 'c      call build_resonance_histories'
      write (15,*) '     call buildresgroups(flst_nborn,nlegborn,flst_bornlength,'
      write (15,*) '    1     flst_born,flst_bornres,flst_bornresgroup,flst_nbornresgroup)'
      write (15,*) '     call buildresgroups(flst_nreal,nlegreal,flst_reallength,'
      write (15,*) '    1     flst_real,flst_realres,flst_realresgroup,flst_nrealresgroup)'

      write (15,*) '     write(*,*) '
      write (15,*) "     write(*,*) '*********   SUMMARY  *********'"
      write (15,*) "     write(*,*) 'set nlegborn to: ',maxval(flst_bornlength(1:flst_nborn))"
      write (15,*) "     write(*,*) 'set nlegreal to: ',maxval(flst_reallength(1:flst_nreal))"
      
      write (15,*) '     nmaxres_real = maxval(flst_realres(1:flst_reallength(flst_nreal),1:flst_nreal)) - 2'
      write (15,*) '     nmaxres_born = maxval(flst_bornres(1:flst_bornlength(flst_nborn),1:flst_nborn)) - 2'
      write (15,*) "     write(*,*) 'max number of resonances: ',max(nmaxres_real,nmaxres_born)"
      
      write (15,1) 'c     add (-1) for overall azimuthal rotation of the event around the beam axis'
      write (15,*) '     dim_integ = (flst_numfinal+1)*3 - 4 + 2 + max(nmaxres_real,nmaxres_born)'
      write (15,*) "     write(*,*) 'set ndiminteg to: ',dim_integ "


      write (15,*) "     write(*,*) 'flst_nbornresgroup ',flst_nbornresgroup "
      write (15,*) "     write(*,*) 'flst_nrealresgroup ',flst_nrealresgroup "

      write (15,*) "     write(*,*) '*********   END SUMMARY  *********'"
      write (15,*) '     write(*,*)'
      ...
      write (15,*) '     include "pwhg_flst.h"'
      write (15,*) ''
      write (15,*) '     flst_bornlength = ',npart(1)
      write (15,*) '     flst_numfinal = ',npart(1) - 2
      do i=1,total_proc
         do j=1,npart(1)
