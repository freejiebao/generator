...
mcCommonWeightNoMatch = 'LepWPCut*METFilter_MC*(Lepton_pt[0]<=200)*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeight = 'LepWPCut*METFilter_MC*(Lepton_pt[0]<=200)*PromptGenLepMatch2l*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeightNoMatch_new = 'LepWPCut*METFilter_MC*(Lepton_pt[0]>200)*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeight_new = 'LepWPCut*METFilter_MC*(Lepton_pt[0]>200)*PromptGenLepMatch2l*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeightNoMatch_ge = 'LepWPCut*METFilter_MC*(Lepton_pt[0]>200)*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeight_ge = 'LepWPCut*METFilter_MC*(Lepton_pt[0]>200)*PromptGenLepMatch2l*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeightNoMatch_res = 'LepWPCut*METFilter_MC*(Lepton_pt[0]>200)*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeight_res = 'LepWPCut*METFilter_MC*(Lepton_pt[0]>200)*PromptGenLepMatch2l*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
############################################
############ MORE MC STAT ##################
############################################
...
mcDirectory = '/afs/cern.ch/work/j/jixiao/latino/prod/nanoAODv7/CMSSW_10_2_23/src/PlotsConfigurations/Configurations/heavyn/sr_2018_double'
for i in ['hmn_m1500']:
