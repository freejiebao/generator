...
nuisances['highpt_mu_scale'] = {
    'name': 'scale_highpt_mu',
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, ['1', '1']) for skey in mc if (skey not in CFMC and skey.startswith('high_'))),
}
nuisances['highpt_mu_res'] = {
    'name': 'res_highpt_mu',
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, ['1', '1']) for skey in mc if (skey not in CFMC and skey.startswith('high_'))),
